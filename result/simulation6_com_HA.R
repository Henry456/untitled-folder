...
for(mu.beta in mu.beta.highs){
  for(sparsity in sparsity_vec){  
    ...
    for(trial in 1:simulations){ 
      try( 
        { 
          ...
          set.seed(trial + 100)
          desM = design_matrix.D(nrow, ncol, beta.star)
          
          cat("n= ", nrow, "p= ", ncol, "mu.beta= ", mu.beta, "s= ", sparsity, "desM.D and HD",  "\n") #HD is high dimension
          ...
          cat("designM(Dh",  ") trial ", trial, " ends. ",  "(av)h1 and h2 are ", end.av[trial, 3]," and ", end.av[trial, 4], "\n")
          cat("designM(Dh",  ") trial ", trial, " ends. ",  "(tr)h1 and h2 are ", end.tr[trial, 3], " and ", end.tr[trial, 4], "\n")
          cat("designM(Dh",  ") trial ", trial, " ends. ",  "(cv)h1 and h2 are = ", end.cv[trial, 3], " and ", end.cv[trial, 4], "\n")
          cat("designM(Dh",  ") trial ", trial, " ends. ",  "(aic)h1 and h2 are = ", end.aic[trial, 3], " and ", end.aic[trial, 4], "\n")
          cat("designM(Dh",  ") trial ", trial, " ends. ",  "(bic)h1 and h2 are = ", end.bic[trial, 3], " and ", end.bic[trial, 4], "\n")
    ...
    myfilename = paste0("Dh", "r", nrow, "c", ncol,  "u", mu.beta, "s", sparsity, ".csv")
